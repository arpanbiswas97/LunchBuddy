...
class Settings(BaseSettings):
    ...
    database_url: str = "postgresql://lunchbuddy:lunchbuddy_password@localhost:5432/lunchbuddy"
    
    # Bot Configuration
    lunch_reminder_time: str = "12:30"
    lunch_reminder_days: str = "Monday,Tuesday,Wednesday"
    
    # Logging Configuration
    log_level: str = "INFO"
    log_file: str = "logs/lunchbuddy.log"
    
    @field_validator('lunch_reminder_days')
    @classmethod
